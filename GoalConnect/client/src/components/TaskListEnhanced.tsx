...
import { Plus, Trash2, Clock, CheckCircle2, GripVertical, ChevronDown, ChevronUp } from "lucide-react";
...
export function TaskListEnhanced({ variant = "full" }: TaskListProps) {
  ...
  const handleDragEnd = (result: DropResult) => {
    ...
    // Optional: Update order on server
    // You could add an API endpoint to save task order
  };
...
function TaskCard({ todo, isCompleting, onComplete, onDelete, compact, isDraggable, dragHandleProps }: TaskCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {todo.description && !compact && !expanded && (
