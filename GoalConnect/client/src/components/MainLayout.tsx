import { Home, Target, ListTodo, Settings, Mountain, BookOpen, TrendingUp, GraduationCap, CalendarCheck } from "lucide-react";
...
const navItems = [
  ...
  { path: "/yearly-goals", icon: CalendarCheck, label: "Yearly Goals" },
