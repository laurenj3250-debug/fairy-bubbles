      ...
      <div className="max-w-[1440px] mx-auto px-6 py-6 space-y-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 min-h-[420px]">
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            ...
            {/* Basecamp status */}
            <div className="relative bg-card/60 backdrop-blur-sm border border-card-border rounded-2xl p-4 shadow-lg overflow-hidden">
              <div
        ...
        {missedDaysThisWeek >= 3 && (
          <div className="relative bg-card/60 backdrop-blur-sm border border-border/50 rounded-2xl p-4 shadow-lg overflow-hidden">
            <div
              className="absolute inset-0 pointer-events-none opacity-30"
              style={{
                backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)' opacity='0.03'/%3E%3C/svg%3E")`,
