...
function RewardCard({
  ...
  return (
    <div className={cn(
      ...
      isTarget
        ? "border-[rgba(225,164,92,0.3)] bg-[rgba(225,164,92,0.8)]/[0.05]"
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5">
            {isTarget && (
              <Pin className="w-3 h-3 text-[var(--sd-text-accent)] flex-shrink-0" />
            )}
            <h3 className="text-sm font-medium text-[var(--text-primary)] truncate">
              {reward.title}
            </h3>
        ...
        <span className="text-xs font-semibold text-[var(--sd-text-accent)] whitespace-nowrap">
          {reward.cost} XP
        </span>
      </div>
        ...
        <div className="h-2 bg-white/5 rounded-full overflow-hidden">
          <div
            className={cn(
              ...
              canAfford ? "bg-[rgba(225,164,92,0.8)]" : "bg-[rgba(225,164,92,0.8)]/60"
            )}
      ...
      <div className="flex items-center gap-2 mt-3">
            ...
            <button
              ...
              className={cn(
                ...
                canAfford && !isRedeeming
                  ? "bg-[rgba(225,164,92,0.8)] hover:bg-[rgba(225,164,92,0.8)] text-white"
          ...
          <AlertDialogContent className="bg-gray-900 border-white/10">
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction
                ...
                className="bg-[rgba(225,164,92,0.8)] hover:bg-[rgba(225,164,92,0.8)] text-white"
              >
        ...
        <button
          ...
          className={cn(
            ...
            isTarget
              ? "bg-[rgba(225,164,92,0.8)]/20 text-[var(--sd-text-accent)] hover:bg-[rgba(225,164,92,0.8)]/30"
              : "bg-white/5 text-[var(--text-muted)] hover:bg-[rgba(225,164,92,0.8)]/10 hover:text-[var(--sd-text-accent)]"
          )}
      ...
      <DialogContent className="bg-gray-900 border-white/10 sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-[var(--text-primary)] flex items-center gap-2">
            <Gift className="w-5 h-5 text-[var(--sd-text-accent)]" />
            Create Reward
          </DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 mt-2">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)] focus:outline-none focus:ring-2 focus:ring-[rgba(225,164,92,0.4)] focus:border-[rgba(225,164,92,0.4)]"
            />
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={2}
              className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)] focus:outline-none focus:ring-2 focus:ring-[rgba(225,164,92,0.4)] focus:border-[rgba(225,164,92,0.4)] resize-none"
            />
          ...
          <button
            ...
            className="w-full rounded-lg bg-[rgba(225,164,92,0.8)] hover:bg-[rgba(225,164,92,0.8)] text-white font-medium py-2.5 text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
    ...
    <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Gift className="w-6 h-6 text-[var(--sd-text-accent)]" />
        ...
        <div className="flex items-center gap-3">
          {points && (
            <div className="flex items-center gap-1.5 rounded-full bg-[rgba(225,164,92,0.8)]/10 border border-peach-400/20 px-3 py-1.5">
              <Sparkles className="w-3.5 h-3.5 text-[var(--sd-text-accent)]" />
              <span className="text-xs font-semibold text-[var(--sd-text-accent)]">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg bg-[rgba(225,164,92,0.8)] hover:bg-[rgba(225,164,92,0.8)] text-white px-3 py-2 text-xs font-medium transition-colors"
          >
      ...
      {!rewardsLoading && !rewardsError && rewards.length === 0 && (
        <div className="rounded-xl border border-white/10 bg-white/[0.03] backdrop-blur-sm p-8 text-center">
          <div className="flex justify-center mb-4">
            <div className="flex items-center justify-center w-14 h-14 rounded-full bg-[rgba(225,164,92,0.8)]/10">
              <Gift className="w-7 h-7 text-[var(--sd-text-accent)]" />
            </div>
          </div>
          ...
          <button
            onClick={() => setCreateDialogOpen(true)}
            className="inline-flex items-center gap-1.5 rounded-lg bg-[rgba(225,164,92,0.8)] hover:bg-[rgba(225,164,92,0.8)] text-white px-4 py-2 text-xs font-medium transition-colors"
          >
            <Plus className="w-3.5 h-3.5" />
            Create Reward
          </button>
